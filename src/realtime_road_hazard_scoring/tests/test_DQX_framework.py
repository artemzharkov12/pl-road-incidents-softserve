...
QUARANTINE_TABLE = f"{SILVER_CATALOG}.{SILVER_SCHEMA}.silver_streaming_weather_DQX_quarantine"
...
if not df_recent.isEmpty():
    ...
    dq_checks = [
            ...
            DQRowRule(
                ...
                check_func_kwargs={"min_limit": -50, "max_limit": 100}
            )
        ]
