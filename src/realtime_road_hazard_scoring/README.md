...
This folder defines all source code for the 'realtime_road_hazard_scoring' pipeline:
...
* Take a look at the sample under "sample_users_realtime_road_hazard_scoring.py" to get familiar with the syntax.
